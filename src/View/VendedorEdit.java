 ...
 * @author Anthony
 */
public class VendedorEdit extends javax.swing.JFrame {
    
    private ControleVendedor vendCtrl;
    private int index;

    /**
     * Creates new form VendedorEdit
     */
    public VendedorEdit(int pIndex) {
        this.vendCtrl = new ControleVendedor();
        this.index = pIndex;
        Vendedor tmp01 = this.vendCtrl.getVendedorByIndex(pIndex);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Vendedor tmp = new Vendedor(cpf, nome, email, fone, contatoPref);

        try{
            this.vendCtrl.editaVendedor(index, tmp);
            JOptionPane.showMessageDialog(this, "Edição feito com êxito!","Sucesso", JOptionPane.INFORMATION_MESSAGE);
            VendedorList ce = new VendedorList();
            ce.setVisible(true);
