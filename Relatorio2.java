...
public class Relatorio2 /*extends JFrame implements ActionListener*/{
   ...
   // }*/
    ...
    public Relatorio2(Calendar dataI, Calendar dataF, Imovel codIm) {
        this.dataI = dataI;
        this.dataF = dataF;
        this.codIm = codIm;
    ...
    public static void main(String[] args) {
        /*JFrame r = new Relatorio2();
        r.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        r.setVisible(true);*/
        //Relatorio2 r = new Relatorio2(23-02-2019,04-12-2019,1234);
    }
}
